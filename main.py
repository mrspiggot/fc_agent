...
class LuciUIController:
    ...
    def setup_ui(self):
        ...
        st.header("Lucidate Alchemy Article Generator:")
...
class LuciArticleEnhancer:
    ...
    def execute_enhancements(self, questions, article):
...
if __name__ == "__main__":
    ...
    article_enhancer = LuciArticleEnhancer(ui_controller)

    if st.button("Run"):
        article = LuciArticleGenerator(ui_controller).generate()
        with st.spinner("To enhance the document the following questions may be asked:"):
            enhancements = article_enhancer.suggest_enhancements(article)
            article = article_enhancer.execute_enhancements(enhancements, article)
